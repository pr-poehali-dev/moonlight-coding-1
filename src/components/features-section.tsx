...
export function FeaturesSection() {
  ...
  return (
    <section ref={ref as React.RefObject<HTMLElement>} className="py-24 px-6 bg-background">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          <div className="space-y-6">
            <div className="glow-border rounded-xl p-6 reveal-left">
          ...
          <div className="glow-border rounded-xl p-6 space-y-5 reveal-right">
